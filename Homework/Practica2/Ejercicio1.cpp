//
// Ejercicio 1 Venta limonadas.
//
#include "iostream"

using namespace std;
//variables globales constantes precios y descuentos.
...
bool menu() {
    ...
    while (true) {
        //solicitamos producto con un menu.
        ...
        if (opcion == 1) {
            ...
            //Se entra en el proceso de generar la factura
